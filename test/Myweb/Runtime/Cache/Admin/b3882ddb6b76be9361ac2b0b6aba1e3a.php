...
<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/ThinkPHP/test/index.php/Admin/Comment/insert" method="post" enctype="multipart/form-data">
                    		
                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">评论用户</label>
                    				<div class="mws-form-item">
                    					<input class="large" type="text" name="user_id" value="">
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                                    <label class="mws-form-label">评论商品</label>
                                    <div class="mws-form-item">
                                        <input class="large" type="text" name="shop_id" value="">
                                    </div>
                                </div>
                    			<div class="mws-form-row">
                    		...
                    		<div class="mws-button-row">
                    			...
                    			<input value="Submit" class="btn btn-success" type="submit" value="提交">
                    			<input value="Reset" class="btn btn-danger" type="reset" value="重置">
                    		</div>
                    	</form>
                    </div>    	
                </div>
