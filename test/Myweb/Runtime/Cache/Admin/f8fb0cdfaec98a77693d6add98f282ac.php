    ...
    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <td class="  sorting_1"><input type="checkbox" value="{<?php echo ($row->id); ?>}"><?php echo ($row['sid']); ?></td> 
        ...
        <td class=" "><?php echo ($row['descr']); ?></td> 
        <td class=" "><?php echo ($row['num']); ?></td> 
        <td class=" "><?php echo ($row['price']); ?></td>
        <td class=" "><?php echo ($row['state']); ?></td>
        <td class=" "><a href="/ThinkPHP/test/index.php/Admin/Shop/delete?id=<?php echo ($row['sid']); ?>" class="btn btn-success"><i class="icon-trash"></i></a><a href="/ThinkPHP/test/index.php/Admin/Shop/edit?id=<?php echo ($row['sid']); ?>" class="btn btn-info"><i class="icon-wrench"></i></a></td> 
