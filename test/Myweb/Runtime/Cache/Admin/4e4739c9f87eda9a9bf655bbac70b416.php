     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <td class="  sorting_1"><?php echo ($row['id']); ?></td>
         <td class=" "><?php echo ($row['uid']); ?></td>
        <td class=" "><?php echo ($row['addtime']); ?></td>
        <td class=" "><?php echo ($row['number']); ?></td>
        <td class=" "><?php echo ($row['address_id']); ?></td>
        <td class=" "><?php echo ($row['total']); ?></td>
        <td class=" "><?php echo ($row['status']); ?></td>
        <td class=" "><a href="/admins/order/delete/{<?php echo ($row->id); ?>}" class="btn btn-success"><i class="icon-trash"></i></a><a href="/admins/order/edit/{<?php echo ($row->id); ?>}" class="btn btn-info"><i class="icon-wrench"></i></a>|<a href="/ThinkPHP/test/index.php/Admin/Order/xiangqing?id=<?php echo ($row['id']); ?>">订单详情</a></td> 
