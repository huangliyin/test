...
<div class="mws-panel grid_8">
	...
	<form class="mws-form" action="/ThinkPHP/test/index.php/Admin/Link/update" method="post" enctype="multipart/form-data">
		...
		<div class="mws-form-inline">
			<div class="mws-form-row">
               ...
               <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                         <input class="large" type="text" name="url" value="<?php echo ($info['url']); ?>">
                    </div>
               </div>
