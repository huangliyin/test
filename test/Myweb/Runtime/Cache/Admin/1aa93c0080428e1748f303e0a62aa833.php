  ...
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
     <form action="/ThinkPHP/test/index.php/Admin/Link/index" method="get">
      <div class="dataTables_filter" id="DataTables_Table_1_filter">
        <label>搜索: <input aria-controls="DataTables_Table_1" type="text" name="name" value="<?php echo ($link['name'] or ''); ?>"/></label><input type="submit" value="搜索">
      </div>
     </form>
     ...
     <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info"> 
      ...
      <tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <td class=" "><a href="/ThinkPHP/test/index.php/Admin/Link/delete?id=<?php echo ($row['id']); ?>" class="btn btn-success"><i class="icon-trash"></i></a><a href="/ThinkPHP/test/index.php/Admin/Link/edit?id=<?php echo ($row['id']); ?>" class="btn btn-info"><i class="icon-wrench"></i></a></td> 
