...
<div class="mws-panel-body no-padding">
     <form class="mws-form" action="/ThinkPHP/test/index.php/Admin/Ad/update" method="post" enctype="multipart/form-data">
     	...
     	<div class="mws-form-inline">
     		<div class="mws-form-row">
               ...
               <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                         <input  type="radio" name="fanwei"  value="1" />底部&nbsp;&nbsp;&nbsp;&nbsp;
                         <input  name="fanwei" type="radio"  value="2" />左侧
     		...
     		<div class="mws-form-row">
     			...
     			<div class="mws-form-item"> 
                         <input  name="expire" type="radio"  value="1" >限时&nbsp;&nbsp;&nbsp;&nbsp;
     				<input  name="expire" type="radio"  value="2" >不限时
     			</div>
     		</div>
               ...
               <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                         <input class="large" type="text" name="endtime" value="<?php echo ($info['eddtime']); ?>">
                    </div>
               </div>
     		...
     		<div class="mws-form-row">
     			...
     			<div class="mws-form-item">
     				<input class="large" type="text" name="code" value="<?php echo ($info['code']); ?>">
     			</div>
     		</div>
               <div class="mws-form-row">
