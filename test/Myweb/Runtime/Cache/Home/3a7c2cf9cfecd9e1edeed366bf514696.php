...
<div class="i_bg">
	<div class="postion">
        ...
        <span class="n_ch">
            ...
            <a href="#"><img src="/ThinkPHP/test/Public/images/s_close.gif" /></a>
        </span>
    </div>
    <!--Begin 筛选条件 Begin-->
    ...
    <div class="content mar_20">
    	<div class="l_history">
        	...
        	<ul>
            	<li>
                    <div class="img"><a href="#"><img src="/ThinkPHP/test/Public/images/his_1.jpg" width="185" height="162" /></a></div>
                ...
                <li>
                    <div class="img"><a href="#"><img src="/ThinkPHP/test/Public/images/his_2.jpg" width="185" height="162" /></a></div>
                	<div class="name"><a href="#">Dior/迪奥香水2件套装</a></div>
                    <div class="price">
                ...
                <li>
                    <div class="img"><a href="#"><img src="/ThinkPHP/test/Public/images/his_3.jpg" width="185" height="162" /></a></div>
                	<div class="name"><a href="#">Dior/迪奥香水2件套装</a></div>
                    <div class="price">
                ...
                <li>
                    <div class="img"><a href="#"><img src="/ThinkPHP/test/Public/images/his_4.jpg" width="185" height="162" /></a></div>
                	<div class="name"><a href="#">Dior/迪奥香水2件套装</a></div>
                    <div class="price">
                    	<font>￥<span>368.00</span></font> &nbsp; 18R
                    </div>
                ...
                <li>
                    <div class="img"><a href="#"><img src="/ThinkPHP/test/Public/images/his_5.jpg" width="185" height="162" /></a></div>
                	<div class="name"><a href="#">Dior/迪奥香水2件套装</a></div>
                    <div class="price">
                    	<font>￥<span>368.00</span></font> &nbsp; 18R
                    </div>
        ...
        <div class="l_list">
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                   <?php if(is_array($dd)): foreach($dd as $key=>$row): ?><li>
                    	<div class="img"><a href="/ThinkPHP/test/index.php/Home/Web/xiangqing?id=<?php echo ($row['id']); ?>"><img src="/ThinkPHP/test/Public/<?php echo ($row['pic']); ?>" width="210" height="185" /></a></div>
                        <div class="price">
                        ...
                        <div class="carbg">
                            ...
                            <a href="/xq?id={<?php echo ($yiji->sid); ?>" class="j_car">加入购物车</a>
                        </div>
                    </li><?php endforeach; endif; ?>              
                </ul>
