 ...
 <body>
  <div class="mws-panel grid_8"> 
   ...
   <div class="mws-panel-body no-padding"> 
    <form class="mws-form" action="/ThinkPHP/test/index.php/Admin/User/update" method="post"> 
        <input type="hidden" value="<?php echo ($user['id']); ?>" name="id">
     <div class="mws-form-inline"> 
      <div class="mws-form-row"> 
       <label class="mws-form-label">用户名</label> 
       <div class="mws-form-item"> 
        <input class="small" type="text" name="username" value="<?php echo ($user['username']); ?>"/> 
       </div> 
      </div> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="small" type="text" name="age" value="<?php echo ($user['age']); ?>"/> 
       </div> 
      </div> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <td><input type="radio" name="sex" value="1" <?php if($user["sex"] == 1): ?>checked<?php endif; ?>/>男 
          <input type="radio" name="sex" value="2" <?php if($user["sex"] == 2): ?>checked<?php endif; ?>/>女</td>
       </div> 
      </div> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="small" type="text" name="phone" value="<?php echo ($user['phone']); ?>"/> 
       </div> 
      </div> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="small" type="text" name="email" value="<?php echo ($user['email']); ?>"/> 
       </div> 
      </div> 
      ...
      <div class="mws-form-row"> 
       ...
       <div class="mws-form-item"> 
        <input class="small" type="text" name="status" value="<?php echo ($user['status']); ?>"/> 
       </div> 
      </div> 
