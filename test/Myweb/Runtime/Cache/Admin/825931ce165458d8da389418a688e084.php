...
<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/ThinkPHP/test/index.php/Admin/User/cateupdate" method="post">
                    		<input type="hidden" name='id' value="<?php echo ($cate['id']); ?>">
                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">分类名</label>
                    				<div class="mws-form-item">
                    					<input class="large" type="text" name="name" value="<?php echo ($cate['name']); ?>">
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<select class="large" name="pid">
                    					   ...
                    					   <?php if(is_array($cates)): foreach($cates as $key=>$row): ?><option value="<?php echo ($row['id']); ?>" <?php if($row['id'] == $cate['pid']): ?>selected<?php endif; ?>>
                                                       <?php echo ($row['name']); ?>
