...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
    	<form class="mws-form" action="/ThinkPHP/test/index.php/Admin/Shop/update" method="post" enctype="multipart/form-data">
    		
    		<div class="mws-form-inline">
    			<div class="mws-form-row">
    				<label class="mws-form-label">商品名</label>
    				<div class="mws-form-item">
    					<input class="large" type="text" name="name" value="<?php echo ($info['name']); ?>">
    				</div>
    			</div>
    			...
    			<div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <script id="editor" name="descr" type="text/plain" style="width:800px;height:500px;"><?php echo ($info['descr']); ?></script>
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">图片</label>
                    <div class="mws-form-item">
                        <img src="/ThinkPHP/test/Public/<?php echo ($info['pic']); ?>" width="100px" height="100px" >
                    </div>
                </div>
                <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            ...
                            <input style="position: absolute; top: 0px; right: 0px; margin: 0px; cursor: pointer; font-size: 999px; opacity: 0; z-index: 999;" type="file" name="pic"></span></div>
                        </div>
                </div>
                ...
                <div class="mws-form-row">
    				...
    				<div class="mws-form-item">
    					<input class="large" type="text" name="num" value="<?php echo ($info['num']); ?>">
    				</div>
    			</div>
                 ...
                 <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input class="large" type="text" name="price" value="<?php echo ($info['price']); ?>">
                    </div>
                </div>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input  type="radio" name="state"  value="1" <?php if($info['state'] == 1): ?>selected<?php endif; ?>/>上架&nbsp;&nbsp;&nbsp;&nbsp;
                        <input  name="state" type="radio"  value="2" <?php if($info['state'] == 2): ?>selected<?php endif; ?>/>下架
                    </div>
                </div>
