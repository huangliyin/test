...
<link rel="stylesheet" type="text/css" href="/ThinkPHP/test/Public/b/css/login.css" media="screen">
...
<body>
    ...
    <div id="mws-login-wrapper">
        <div id="mws-login">
            ...
            <div id="mws-login-form">
                <form class="mws-form" action="/ThinkPHP/test/index.php/Admin/Login/check" method="post">
    ...
    <script src="/ThinkPHP/test/Public/b/jui/js/jquery-ui-effects.min.js"></script>

    <!-- Plugin Scripts -->
    <script src="/ThinkPHP/test/Public/b/plugins/validate/jquery.validate-min.js"></script>

    <!-- Login Script -->
    <script src="/ThinkPHP/test/Public/b/js/core/login.js"></script>
