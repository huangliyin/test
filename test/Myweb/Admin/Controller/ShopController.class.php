...
class ShopController extends Controller {
    public function index(){
		...
		$list = $mod->join('cate on shops.cate_id=cate.id')->where($where)->limit($page->firstRow,$page->listRows)->field('cate.name as cname,shops.name as sname,shops.descr,shops.num,shops.id as sid,shops.pic,shops.state,shops.price')->select();
		// var_dump($list);exit;
		// 加载模板  分配变量
