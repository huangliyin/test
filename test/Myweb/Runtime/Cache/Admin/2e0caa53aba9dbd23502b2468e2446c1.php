...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
    	<form class="mws-form" action="/ThinkPHP/test/index.php/Admin/Comment/update" method="post" enctype="multipart/form-data">
    		
    		<div class="mws-form-inline">
    			<div class="mws-form-row">
    				<label class="mws-form-label">评论用户</label>
    				<div class="mws-form-item">
    					<input class="large" type="text" name="user_id" value="<?php echo ($info['user_id']); ?>">
    				</div>
    			</div>
    			<div class="mws-form-row">
    				<label class="mws-form-label">评论商品</label>
    				<div class="mws-form-item">
    					<input class="large" type="text" name="shop_id" value="<?php echo ($info['shop_id']); ?>">
    				</div>
    			</div>
    			<div class="mws-form-row">
    				<label class="mws-form-label">评论内容</label>
    				<div class="mws-form-item">
    					<script id="editor" name="content" type="text/plain" style="width:800px;height:500px;"><?php echo ($info['content']); ?></script>
    				</div>
    			</div>
    			<div class="mws-form-row">
    				<label class="mws-form-label">评论图片</label>
    				<div class="mws-form-item">
    		...
    		<div class="mws-button-row">
    			...
    			<input value="Reset" class="btn btn-danger" type="reset" >
    		</div>
    	</form>
    </div>    	
</div>
